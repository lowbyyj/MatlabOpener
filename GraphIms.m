...
set(gca,'FontSize',32);
hold on
title('Altitude by time multiple 30 all route');
xlabel('Sample Index (2 sample/second)','FontSize',32);
ylabel('Altitude (m)','FontSize',32)
plot(Data_4_round_1_altitude);
plot(Data_4_round_2_altitude);
plot(Data_4_round_3_altitude);
plot(Data_4_round_4_altitude);
plot(Data_4_round_5_altitude);
plot(Data_4_round_6_altitude);
plot(Data_4_round_7_altitude);
plot(Data_4_round_8_altitude);
plot(Data_4_round_9_altitude);
plot(Data_4_round_10_altitude);
plot(Data_4_round_11_altitude);
plot(Data_4_round_12_altitude);
plot(Data_4_round_13_altitude);
plot(Data_4_round_14_altitude);
plot(Data_4_round_15_altitude);
plot(Data_4_round_16_altitude);
%%
figure();
set(gca,'FontSize',32);
hold on
title('RSRP by time multiple 30 all route');
xlabel('Sample Index (2 sample/second)','FontSize',32);
ylabel('RSRP (dBm)','FontSize',32)
ylim([0 16])

cqiH = [];
cqiH = [cqiH; Data_4_round_1_cqi(1:190)];
cqiH = [cqiH; Data_4_round_2_cqi(1:190)];
cqiH = [cqiH; Data_4_round_3_cqi(1:190)];
cqiH = [cqiH; Data_4_round_4_cqi(1:190)];
cqiH = [cqiH; Data_4_round_5_cqi(1:190)];
cqiH = [cqiH; Data_4_round_6_cqi(1:190)];
cqiH = [cqiH; Data_4_round_7_cqi(1:190)];
cqiH = [cqiH; Data_4_round_8_cqi(1:190)];
cqiH = [cqiH; Data_4_round_9_cqi(1:190)];
cqiH = [cqiH; Data_4_round_10_cqi(1:190)];
cqiH = [cqiH; Data_4_round_11_cqi(1:190)];
cqiH = [cqiH; Data_4_round_12_cqi(1:190)];
cqiH = [cqiH; Data_4_round_13_cqi(1:190)];
cqiH = [cqiH; Data_4_round_14_cqi(1:190)];
cqiH = [cqiH; Data_4_round_15_cqi(1:190)];
cqiH = [cqiH; Data_4_round_16_cqi(1:190)];
cqiH_mean = mean(cqiH);
...
ylim([0 16])
plot(Data_4_round_1_cqi);
plot(Data_4_round_2_cqi);
plot(Data_4_round_3_cqi);
plot(Data_4_round_4_cqi);
plot(Data_4_round_5_cqi);
plot(Data_4_round_6_cqi);
plot(Data_4_round_7_cqi);
plot(Data_4_round_8_cqi);
plot(Data_4_round_9_cqi);
plot(Data_4_round_10_cqi);
plot(Data_4_round_11_cqi);
plot(Data_4_round_12_cqi);
plot(Data_4_round_13_cqi);
plot(Data_4_round_14_cqi);
plot(Data_4_round_15_cqi);
plot(Data_4_round_16_cqi);
